// ------------------------------------------------------------------------------------
// EE569 Homework Assignment #1 Prob3a (Mix noise)
...
int main(int argc, char* argv[])
{
	...
	if (strcmp(argv[7], "lpf") == 0)
	{
		...
		FileWriteHist3d("pepper_clean_hist_lpf.txt", HistClean);
		...
		FileWrite("pepper_clean_red_lpf.raw", CleanImage1d, ImgHeight*ImgWidth);
		CleanImage1d = Img2dTo1d(CleanImageG, ImgHeight, ImgWidth);
		FileWrite("pepper_clean_green_lpf.raw", CleanImage1d, ImgHeight*ImgWidth);
		CleanImage1d = Img2dTo1d(CleanImageB, ImgHeight, ImgWidth);
		FileWrite("pepper_clean_blue_lpf.raw", CleanImage1d, ImgHeight*ImgWidth);
	}
	...
	else if (strcmp(argv[7], "median") == 0)
	{
		...
		unsigned long HistClean[256][3];
		Histogram3d(HistClean, CleanImage3d, ImgHeight, ImgWidth, BytesPerPixel);
		FileWriteHist3d("pepper_clean_hist_median.txt", HistClean);
		...
		/* Convert images 2D to 1D so that clean images channel wise can be written to file */
		CleanImage1d = Img2dTo1d(CleanImageR, ImgHeight, ImgWidth);
		FileWrite("pepper_clean_red_median.raw", CleanImage1d, ImgHeight*ImgWidth);
		CleanImage1d = Img2dTo1d(CleanImageG, ImgHeight, ImgWidth);
		FileWrite("pepper_clean_green_median.raw", CleanImage1d, ImgHeight*ImgWidth);
		CleanImage1d = Img2dTo1d(CleanImageB, ImgHeight, ImgWidth);
		FileWrite("pepper_clean_blue_median.raw", CleanImage1d, ImgHeight*ImgWidth);
	}
	...
	else if (strcmp(argv[7], "gauss") == 0)
	{
		...
		unsigned long HistClean[256][3];
		Histogram3d(HistClean, CleanImage3d, ImgHeight, ImgWidth, BytesPerPixel);
		FileWriteHist3d("pepper_clean_hist_gauss.txt", HistClean);
		...
		/* Convert images 2D to 1D so that noisy images channel wise can be written to file */
		CleanImage1d = Img2dTo1d(CleanImageR, ImgHeight, ImgWidth);
		FileWrite("pepper_clean_red_gauss.raw", CleanImage1d, ImgHeight*ImgWidth);
		CleanImage1d = Img2dTo1d(CleanImageG, ImgHeight, ImgWidth);
		FileWrite("pepper_clean_green_gauss.raw", CleanImage1d, ImgHeight*ImgWidth);
		CleanImage1d = Img2dTo1d(CleanImageB, ImgHeight, ImgWidth);
		FileWrite("pepper_clean_blue_gauss.raw", CleanImage1d, ImgHeight*ImgWidth);
	}
	...
	else if (strcmp(argv[7], "outlier") == 0)
	{
		...
		unsigned long HistClean[256][3];
		Histogram3d(HistClean, CleanImage3d, ImgHeight, ImgWidth, BytesPerPixel);
		FileWriteHist3d("pepper_clean_hist_outlier.txt", HistClean);
		...
		/* Convert images 2D to 1D so that noisy images channel wise can be written to file */
		CleanImage1d = Img2dTo1d(CleanImageR, ImgHeight, ImgWidth);
		FileWrite("pepper_clean_red_outlier.raw", CleanImage1d, ImgHeight*ImgWidth);
		CleanImage1d = Img2dTo1d(CleanImageG, ImgHeight, ImgWidth);
		FileWrite("pepper_clean_green_outlier.raw", CleanImage1d, ImgHeight*ImgWidth);
		CleanImage1d = Img2dTo1d(CleanImageB, ImgHeight, ImgWidth);
		FileWrite("pepper_clean_blue_outlier.raw", CleanImage1d, ImgHeight*ImgWidth);
	}
	...
	else if (strcmp(argv[7], "medianmedian") == 0)
	{
		...
		unsigned long HistClean[256][3];
		Histogram3d(HistClean, CleanImage3d, ImgHeight, ImgWidth, BytesPerPixel);
		FileWriteHist3d("pepper_clean_hist_mix.txt", HistClean);
		...
		/* Convert images 2D to 1D so that noisy images channel wise can be written to file */
		CleanImage1d = Img2dTo1d(CleanImageR, ImgHeight, ImgWidth);
		FileWrite("pepper_clean_red_mix.raw", CleanImage1d, ImgHeight*ImgWidth);
		CleanImage1d = Img2dTo1d(CleanImageG, ImgHeight, ImgWidth);
		FileWrite("pepper_clean_green_mix.raw", CleanImage1d, ImgHeight*ImgWidth);
		CleanImage1d = Img2dTo1d(CleanImageB, ImgHeight, ImgWidth);
		FileWrite("pepper_clean_blue_mix.raw", CleanImage1d, ImgHeight*ImgWidth);
	}
