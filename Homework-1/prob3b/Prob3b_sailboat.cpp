// ------------------------------------------------------------------------------------
// EE569 Homework Assignment #1 Prob3b_sailboat
...
int main(int argc, char* argv[])
{
	...
	if (strcmp(argv[7], "nlm") == 0)
	{
		...
		FileWriteHist3d("sailboat_clean_hist_nlm.txt", HistClean);
		...
		FileWrite("sailboat_clean_red_nlm.raw", CleanImage1d, ImgHeight*ImgWidth);
		CleanImage1d = Img2dTo1d(CleanImageG, ImgHeight, ImgWidth);
		FileWrite("sailboat_clean_green_nlm.raw", CleanImage1d, ImgHeight*ImgWidth);
		CleanImage1d = Img2dTo1d(CleanImageB, ImgHeight, ImgWidth);
		FileWrite("sailboat_clean_blue_nlm.raw", CleanImage1d, ImgHeight*ImgWidth);
	}
