...
% open the files
fid=fopen('bedroom_hsv_hist.txt');
fid1=fopen('bedroom_hsv_eq_hist.txt');
...
xlabel('Pixel intensity');
ylabel('Number of pixels');
title('Histogram equalized (Red) component by HSV');
...
xlabel('Pixel intensity');
ylabel('Number of pixels');
title('Histogram equalized (Green) component by HSV');
...
xlabel('Pixel intensity');
ylabel('Number of pixels');
title('Histogram equalized (Blue) component by HSV');