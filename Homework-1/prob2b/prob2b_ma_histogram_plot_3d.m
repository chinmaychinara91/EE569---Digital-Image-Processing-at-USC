...
% open the files
fid=fopen('bedroom_ma_hist.txt');
fid1=fopen('bedroom_ma_eq_hist.txt');
...
xlabel('Pixel intensity');
ylabel('Number of pixels');
title('Histogram equalized (Red) component method A');
...
xlabel('Pixel intensity');
ylabel('Number of pixels');
title('Histogram equalized (Green) component method A');
...
xlabel('Pixel intensity');
ylabel('Number of pixels');
title('Histogram equalized (Blue) component method A');